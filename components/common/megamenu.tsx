...
import { LucideIcon, Smartphone, Shirt, Home as HomeIcon, Sparkles, Dumbbell, Zap, Percent, Gift } from "lucide-react";
  ...
  categories: [
    {
      ...
      subcategories: [
        ...
        { label: "TVs & Displays", path: "/categories/electronics/tvs-displays" },
        { label: "Audio & Headphones", path: "/categories/electronics/audio-headphones" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { label: "Women's Clothing", path: "/categories/fashion/womens-clothing" },
    ...
    },
    {
      ...
      subcategories: [
        ...
        { label: "Kitchen Appliances", path: "/categories/home-kitchen/kitchen-appliances" },
    ...
    },
    {
      ...
      subcategories: [
        { label: "Fitness Equipment", path: "/categories/sports-outdoors/fitness-equipment" },
        { label: "Outdoor Gear", path: "/categories/sports-outdoors/outdoor-gear" },
        { label: "Sports Wear", path: "/categories/sports-outdoors/sports-wear" },
      ],
    },
  ],
  quickLinks: [
...
export default function MegaMenu({ data = defaultData, onClose }: MegaMenuProps) {
  const { categories, quickLinks } = data;

  return (
    <div className="absolute  left-0 right-0 bg-background border-b border-border shadow-popup animate-fade-in pt-1">
      <div className="container  mx-10 px-4 py-6">
