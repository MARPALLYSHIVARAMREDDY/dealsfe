    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2">
          ...
          >
            <ArrowLeft className="h-6 w-6 text-gray-500" aria-hidden="true" />
          </button>
          ...
          >
            <ArrowRight className="h-6 w-6 text-gray-500" aria-hidden="true" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
...
export const Card = ({
  ...
  return (
    <>
      ...
      {/* Card button (already has accessible name via text) */}
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
